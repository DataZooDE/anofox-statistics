...
/**
 * @brief RLS Predict Aggregate - Apply pre-fitted model to new data
 *
 * Aggregate function that takes a pre-fitted RLS model and applies it
 ...
 */
class RLSPredictAggregateFunction {
public:
