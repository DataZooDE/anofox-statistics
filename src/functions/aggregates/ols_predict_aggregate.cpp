#include "ols_predict_aggregate.hpp"
 ...
 */
static void OLSPredictAggWindow(Vector inputs[], const ValidityMask &filter, AggregateInputData &aggr_input_data,
                                          idx_t input_count, data_ptr_t state_p, const SubFrames &frames,
                                          Vector &result, idx_t rid) {

	auto &state = *reinterpret_cast<OLSPredictAggState *>(state_p);
...
void OLSPredictAggregateFunction::Register(ExtensionLoader &loader) {
	ANOFOX_DEBUG("Registering OLS predict aggregate function");
	...
	AggregateFunction func(
		...
		AggregateFunction::StateSize<OLSPredictAggState>,
		AggregateFunction::StateInitialize<OLSPredictAggState, OLSPredictAggOperation>,
		OLSPredictAggUpdate,
		AggregateFunction::StateCombine<OLSPredictAggState, OLSPredictAggOperation>,
		AggregateFunction::StateFinalize<OLSPredictAggState, double, OLSPredictAggOperation>,
	...
	ANOFOX_DEBUG("OLS predict aggregate function registered successfully");
}
