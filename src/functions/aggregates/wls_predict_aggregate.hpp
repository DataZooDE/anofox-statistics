...
/**
 * @brief WLS Predict Aggregate - Apply pre-fitted model to new data
 *
 * Aggregate function that takes a pre-fitted WLS model and applies it
 ...
 */
class WLSPredictAggregateFunction {
public:
