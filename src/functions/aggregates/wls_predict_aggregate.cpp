#include "wls_predict_aggregate.hpp"
 ...
 */
static void WLSPredictAggWindow(Vector inputs[], const ValidityMask &filter, AggregateInputData &aggr_input_data,
                                          idx_t input_count, data_ptr_t state_p, const SubFrames &frames,
                                          Vector &result, idx_t rid) {

	auto &state = *reinterpret_cast<WLSPredictAggState *>(state_p);
...
void WLSPredictAggregateFunction::Register(ExtensionLoader &loader) {
	ANOFOX_DEBUG("Registering WLS predict aggregate function");
	...
	AggregateFunction func(
		...
		AggregateFunction::StateSize<WLSPredictAggState>,
		AggregateFunction::StateInitialize<WLSPredictAggState, WLSPredictAggOperation>,
		WLSPredictAggUpdate,
		AggregateFunction::StateCombine<WLSPredictAggState, WLSPredictAggOperation>,
		AggregateFunction::StateFinalize<WLSPredictAggState, double, WLSPredictAggOperation>,
	...
	ANOFOX_DEBUG("WLS predict aggregate function registered successfully");
}
