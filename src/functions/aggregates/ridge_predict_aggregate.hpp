...
/**
 * @brief Ridge Predict Aggregate - Apply pre-fitted model to new data
 *
 * Aggregate function that takes a pre-fitted Ridge model and applies it
 ...
 */
class RidgePredictAggregateFunction {
public:
