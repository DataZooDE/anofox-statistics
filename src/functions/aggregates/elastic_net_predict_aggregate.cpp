#include "elastic_net_predict_aggregate.hpp"
...
struct ElasticNetPredictAggOperation {
 ...
 */
static void ElasticNetPredictAggWindow(Vector inputs[], const ValidityMask &filter, AggregateInputData &aggr_input_data,
                                          idx_t input_count, data_ptr_t state_p, const SubFrames &frames,
                                          Vector &result, idx_t rid) {

	auto &state = *reinterpret_cast<ElasticNetPredictAggState *>(state_p);
...
void ElasticNetPredictAggregateFunction::Register(ExtensionLoader &loader) {
	ANOFOX_DEBUG("Registering Elastic-Net predict aggregate function");
	...
	AggregateFunction func(
		...
		AggregateFunction::StateSize<ElasticNetPredictAggState>,
		AggregateFunction::StateInitialize<ElasticNetPredictAggState, ElasticNetPredictAggOperation>,
		ElasticNetPredictAggUpdate,
		AggregateFunction::StateCombine<ElasticNetPredictAggState, ElasticNetPredictAggOperation>,
		AggregateFunction::StateFinalize<ElasticNetPredictAggState, double, ElasticNetPredictAggOperation>,
		nullptr, // simple_update
		nullptr, // bind
		nullptr, // destructor
		nullptr, // cardinality
		ElasticNetPredictAggWindow
	);
	...
	ANOFOX_DEBUG("Elastic-Net predict aggregate function registered successfully");
}
