#include "rls_predict_aggregate.hpp"
 ...
 */
static void RLSPredictAggWindow(Vector inputs[], const ValidityMask &filter, AggregateInputData &aggr_input_data,
                                          idx_t input_count, data_ptr_t state_p, const SubFrames &frames,
                                          Vector &result, idx_t rid) {

	auto &state = *reinterpret_cast<RLSPredictAggState *>(state_p);
...
void RLSPredictAggregateFunction::Register(ExtensionLoader &loader) {
	ANOFOX_DEBUG("Registering RLS predict aggregate function");
	...
	AggregateFunction func(
		...
		AggregateFunction::StateSize<RLSPredictAggState>,
		AggregateFunction::StateInitialize<RLSPredictAggState, RLSPredictAggOperation>,
		RLSPredictAggUpdate,
		AggregateFunction::StateCombine<RLSPredictAggState, RLSPredictAggOperation>,
		AggregateFunction::StateFinalize<RLSPredictAggState, double, RLSPredictAggOperation>,
	...
	ANOFOX_DEBUG("RLS predict aggregate function registered successfully");
}
