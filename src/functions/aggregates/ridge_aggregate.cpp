...
void RidgeAggregateFunction::Register(ExtensionLoader &loader) {
	...
	// New statistical metrics
	ridge_struct_fields.push_back(make_pair("residual_standard_error", LogicalType::DOUBLE));
	ridge_struct_fields.push_back(make_pair("f_statistic", LogicalType::DOUBLE));
	ridge_struct_fields.push_back(make_pair("f_statistic_pvalue", LogicalType::DOUBLE));
	ridge_struct_fields.push_back(make_pair("aic", LogicalType::DOUBLE));
	ridge_struct_fields.push_back(make_pair("aicc", LogicalType::DOUBLE));
	ridge_struct_fields.push_back(make_pair("bic", LogicalType::DOUBLE));
	ridge_struct_fields.push_back(make_pair("log_likelihood", LogicalType::DOUBLE));
	// Coefficient-level inference
	ridge_struct_fields.push_back(make_pair("coefficient_t_statistics", LogicalType::LIST(LogicalType::DOUBLE)));
	ridge_struct_fields.push_back(make_pair("coefficient_p_values", LogicalType::LIST(LogicalType::DOUBLE)));
	ridge_struct_fields.push_back(make_pair("coefficient_ci_lower", LogicalType::LIST(LogicalType::DOUBLE)));
	ridge_struct_fields.push_back(make_pair("coefficient_ci_upper", LogicalType::LIST(LogicalType::DOUBLE)));
	// Intercept-level inference
	ridge_struct_fields.push_back(make_pair("intercept_t_statistic", LogicalType::DOUBLE));
	ridge_struct_fields.push_back(make_pair("intercept_p_value", LogicalType::DOUBLE));
	...
	AggregateFunction anofox_stats_ridge_fit_agg(
	    "anofox_stats_ridge_fit_agg", {LogicalType::DOUBLE, LogicalType::LIST(LogicalType::DOUBLE), LogicalType::ANY},
	...
	AggregateFunction ridge_fit_agg_alias(
	    "ridge_fit_agg", {LogicalType::DOUBLE, LogicalType::LIST(LogicalType::DOUBLE), LogicalType::ANY},
	    LogicalType::STRUCT(ridge_struct_fields), AggregateFunction::StateSize<RidgeAggregateState>, RidgeInitialize,
	    RidgeUpdate, RidgeCombine, RidgeFinalize, FunctionNullHandling::DEFAULT_NULL_HANDLING, nullptr, nullptr,
	    nullptr, nullptr, RidgeWindow, nullptr, nullptr);
