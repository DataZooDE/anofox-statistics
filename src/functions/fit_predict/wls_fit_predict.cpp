 ...
 */
static void WlsFitPredictWindow(duckdb::AggregateInputData &aggr_input_data, const duckdb::WindowPartitionInput &partition,
...
void WlsFitPredictFunction::Register(ExtensionLoader &loader) {
    ...
    AggregateFunction anofox_statistics_fit_predict_wls(
        ...
        AggregateFunction::StateSize<WlsFitPredictState>,
