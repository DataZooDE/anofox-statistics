...
WITH store_level AS (
    SELECT
        ...
        territory_id,
        store_id,
        (ols_fit_agg(sales::DOUBLE, [marketing::DOUBLE], {'intercept': true})).coefficients[1] as store_roi,
        (ols_fit_agg(sales::DOUBLE, [marketing::DOUBLE], {'intercept': true})).r_squared as store_r2,
