-- RLS Fit Predict Benchmark: 1M Groups, 100M Rows, 3 Features
-- Usage: duckdb < benchmark_rls.sql
...
SELECT COUNT(*) AS total_predictions FROM (
    SELECT anofox_stats_rls_fit_predict(y, [x1, x2, x3], {'forgetting_factor': 0.99}) OVER (
