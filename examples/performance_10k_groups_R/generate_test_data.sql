...
COPY performance_data_fit_predict TO 'examples/performance_10k_groups_R/data/performance_data_fit_predict.parquet' (FORMAT PARQUET);
.print '  - Saved: examples/performance_10k_groups_R/data/performance_data_fit_predict.parquet'

-- Save aggregate dataset
COPY performance_data_aggregate TO 'examples/performance_10k_groups_R/data/performance_data_aggregate.parquet' (FORMAT PARQUET);
.print '  - Saved: examples/performance_10k_groups_R/data/performance_data_aggregate.parquet'
...
.print '============================================================================'
.print 'Files created:'
.print '  1. examples/performance_10k_groups_R/data/performance_data_fit_predict.parquet'
...
.print ''
.print '  2. examples/performance_10k_groups_R/data/performance_data_aggregate.parquet'
