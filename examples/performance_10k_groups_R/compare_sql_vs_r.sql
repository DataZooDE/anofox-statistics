...
CREATE OR REPLACE TABLE sql_pred_fix AS
  SELECT * FROM 'examples/performance_10k_groups_R/results/sql_predictions_fixed_single.parquet';

CREATE OR REPLACE TABLE r_pred_fix AS
  SELECT * FROM 'examples/performance_10k_groups_R/results/r_predictions_fixed_single.parquet';
...
CREATE OR REPLACE TABLE sql_models_full AS
  SELECT * FROM 'examples/performance_10k_groups_R/results/sql_group_models_full.parquet';

CREATE OR REPLACE TABLE r_models_full AS
  SELECT * FROM 'examples/performance_10k_groups_R/results/r_group_models_full.parquet';
