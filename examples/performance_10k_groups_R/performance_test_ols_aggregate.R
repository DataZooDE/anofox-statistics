...
#
# Usage:
# Rscript examples/performance_10k_groups_R_ols_aggregate.R
# ============================================================================
...
performance_data <- read_parquet("examples/performance_10k_groups_R/data/performance_data_aggregate.parquet")
...
write_parquet(
  group_models_save,
  "examples/performance_10k_groups_R/results/r_group_models.parquet"
)
...
write_parquet(
  ...
  "examples/performance_10k_groups_R/results/r_group_models_full.parquet"
)
...
cat("  - examples/performance_10k_groups_R/results/r_group_models.parquet\n")
cat("  - examples/performance_10k_groups_R/results/r_group_models_full.parquet\n")
cat("============================================================================\n")
